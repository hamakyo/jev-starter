...
All notable changes to this pre-alpha project will be documented here.
...
No live Jev request, npm publish, GitHub Release, license selection, or distribution-model decision is included in this change.
